...
1. 新しく作成した **Azure Cosmos DB** アカウント リソースに移動し、左側のナビゲーション メニューから **Data Explorer** ペインに移動します。

1. **Data Explorer** で **+ New Container** > **+ New Container** を選択します。

     ![06](media/New-image85.png)

1. 以下の設定で新しいコンテナーを作成し、残りの設定はすべて既定値のままにして、**OK** を選択します:
...
1. 引き続き **Data Explorer** 内で **cosmicworks** データベース ノードを展開し、ナビゲーション ツリー内の新しい **products** コンテナー ノードを選択します。
...
1. **Data Explorer** で **cosmicworks** データベース ノードを展開し、**NOSQL API** ナビゲーション ツリー内の **products** コンテナー ノードを選択します。
