# Lab 12a - DevOps プラクティスを使用して Azure Cosmos DB SQL API ソリューションを管理する
...
- タスク 3: Azure CLI を使用して Azure Cosmos DB NOSQL API リソースを作成する。
...
`cosmosdb sql` コマンド グループには、Azure Cosmos DB の NOSQL API に特有のリソースを管理するコマンドが含まれています。各コマンド グループのオプションは常に `--help` フラグで確認できます。

1. **Visual Studio Code** の既存のターミナルに戻ります。

1. 次のコマンドで、NOSQL API に関連する CLI コマンドを確認します:

    ```
    az cosmosdb sql --help
    ```

1. 次のコマンドで、NOSQL API 用のデータベース管理コマンドを確認します:
...
1. 次のコマンドで、NOSQL API 用のコンテナー管理コマンドを確認します:
...
1. **Data Explorer** で **cosmicworks** データベース ノードを展開し、NOSQL API ナビゲーション ツリーに表示されている **products** コンテナーを確認します。
...
1. **Data Explorer** で **cosmicworks** データベース ノードを展開し、NOSQL API ナビゲーション ツリー内の **products** コンテナーを確認します。
...
- Azure CLI を使用して Azure Cosmos DB NOSQL API リソースを作成しました。
